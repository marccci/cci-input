...
class OwnershipController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.ownerships.index', compact('ownerships'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.ownerships.create');
    }
    ...
    public function store(StoreOwnershipRequest $request)
    {
        ...
        return redirect()->route('frontend.ownerships.index');
    }
    ...
    public function edit(Ownership $ownership)
    {
        ...
        return view('frontend.ownerships.edit', compact('ownership'));
    }
    ...
    public function show(Ownership $ownership)
    {
        ...
        return view('frontend.ownerships.show', compact('ownership'));
    }
