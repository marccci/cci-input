...
class ManufacturersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Manufacturer::with(['creator', 'team'])->select(sprintf('%s.*', (new Manufacturer)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'creator', 'image', 'logo']);
        ...
        return view('admin.manufacturers.index', compact('users', 'teams'));
    }
