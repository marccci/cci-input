...
class User extends Authenticatable
{
    ...
    public function creatorManufacturers()
    {
        return $this->hasMany(Manufacturer::class, 'creator_id', 'id');
    }

    public function creatorEngines()
    {
        return $this->hasMany(Engine::class, 'creator_id', 'id');
    }

    public function creatorCars()
    {
