        ...
        <div class="col-md-12">
            @can('carmodel_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.carmodels.create') }}">
                            ...
                            <tbody>
                                @foreach($carmodels as $key => $carmodel)
                                    <tr data-entry-id="{{ $carmodel->id }}">
                                        ...
                                        <td>
                                            @can('carmodel_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.carmodels.show', $carmodel->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('carmodel_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.carmodels.edit', $carmodel->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('carmodel_delete')
                                                <form action="{{ route('frontend.carmodels.destroy', $carmodel->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('carmodel_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.carmodels.massDestroy') }}",
