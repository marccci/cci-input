    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.manufacturers.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="first_year" id="first_year" value="{{ old('first_year', '1886') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="last_year" id="last_year" value="{{ old('last_year', '2021') }}" step="1" required>
