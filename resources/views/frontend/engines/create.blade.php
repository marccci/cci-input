                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.engines.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="block_config" id="block_config" value="{{ old('block_config', 'inline') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="power_units" id="power_units" value="{{ old('power_units', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="engine_size_units" id="engine_size_units" value="{{ old('engine_size_units', '') }}" required>
