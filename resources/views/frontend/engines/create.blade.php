    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.engines.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cylinder_number" id="cylinder_number" value="{{ old('cylinder_number', '1') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="engine_power" id="engine_power" value="{{ old('engine_power', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Engine::ENGINE_POWER_UNITS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="engine_power_units_{{ $key }}" name="engine_power_units" value="{{ $key }}" {{ old('engine_power_units', 'hp') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="engine_size" id="engine_size" value="{{ old('engine_size', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Engine::ENGINE_SIZE_UNITS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="engine_size_units_{{ $key }}" name="engine_size_units" value="{{ $key }}" {{ old('engine_size_units', 'metric') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="bore" id="bore" value="{{ old('bore', '') }}" step="0.001" required>
                            @if($errors->has('bore'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('bore') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="stroke" id="stroke" value="{{ old('stroke', '') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Engine::BLOCK_CONFIG_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="block_config_{{ $key }}" name="block_config" value="{{ $key }}" {{ old('block_config', 'i') === (string) $key ? 'checked' : '' }} required>
