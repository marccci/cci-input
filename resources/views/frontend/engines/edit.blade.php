    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.engines.update", [$engine->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $engine->description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cylinder_number" id="cylinder_number" value="{{ old('cylinder_number', $engine->cylinder_number) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="engine_size" id="engine_size" value="{{ old('engine_size', $engine->engine_size) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="bore" id="bore" value="{{ old('bore', $engine->bore) }}" step="0.001" required>
                            @if($errors->has('bore'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('bore') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="stroke" id="stroke" value="{{ old('stroke', $engine->stroke) }}" step="0.01" required>
