                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('manufacturer_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.manufacturers.index') }}">
                                            {{ trans('cruds.manufacturer.title') }}
                                        </a>
                                    @endcan
                                    @can('engine_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.engines.index') }}">
                                    ...
                                    @endcan
                                    @can('carmodel_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.carmodels.index') }}">
                                    ...
                                    @endcan
                                    @can('garage_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.garages.index') }}">
