    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cars.update", [$car->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('owner') ? 'is-invalid' : '' }}" type="number" name="owner" id="owner" value="{{ old('owner', $car->owner) }}" step="1" required>
                @if($errors->has('owner'))
                    <div class="invalid-feedback">
                        {{ $errors->first('owner') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carmodel') ? 'is-invalid' : '' }}" type="text" name="carmodel" id="carmodel" value="{{ old('carmodel', $car->carmodel) }}">
