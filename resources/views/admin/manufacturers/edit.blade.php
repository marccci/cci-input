    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.manufacturers.update", [$manufacturer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $manufacturer->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $manufacturer->country) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country_code') ? 'is-invalid' : '' }}" type="text" name="country_code" id="country_code" value="{{ old('country_code', $manufacturer->country_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('first_year') ? 'is-invalid' : '' }}" type="text" name="first_year" id="first_year" value="{{ old('first_year', $manufacturer->first_year) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('last_year') ? 'is-invalid' : '' }}" type="text" name="last_year" id="last_year" value="{{ old('last_year', $manufacturer->last_year) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('owner') ? 'is-invalid' : '' }}" type="text" name="owner" id="owner" value="{{ old('owner', $manufacturer->owner) }}" required>
                @if($errors->has('owner'))
                    <div class="invalid-feedback">
                        {{ $errors->first('owner') }}
                    </div>
