    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.manufacturers.update", [$manufacturer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country_code') ? 'is-invalid' : '' }}" type="text" name="country_code" id="country_code" value="{{ old('country_code', $manufacturer->country_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_year') ? 'is-invalid' : '' }}" type="number" name="first_year" id="first_year" value="{{ old('first_year', $manufacturer->first_year) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_year') ? 'is-invalid' : '' }}" type="number" name="last_year" id="last_year" value="{{ old('last_year', $manufacturer->last_year) }}" step="1" required>
