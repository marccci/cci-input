...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.garage.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.garages.update", [$garage->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $garage->name) }}" required>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('car') ? 'is-invalid' : '' }}" type="number" name="car" id="car" value="{{ old('car', $garage->car) }}" step="1" required>
                @if($errors->has('car'))
                    <div class="invalid-feedback">
                        {{ $errors->first('car') }}
                    </div>
